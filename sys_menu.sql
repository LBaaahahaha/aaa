...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2030 DEFAULT CHARSET=utf8 COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('100', '用户管理', '1', '5', 'user', 'system/user/index', '1', 'C', '0', '0', 'system:user:list', 'user', 'admin', '2018-03-16 11:33:00', 'admin', '2020-05-06 23:26:34', '用户管理菜单');
INSERT INTO `sys_menu` VALUES ('101', '角色管理', '1', '4', 'role', 'system/role/index', '1', 'C', '0', '0', 'system:role:list', 'peoples', 'admin', '2018-03-16 11:33:00', 'admin', '2020-05-06 23:27:52', '角色管理菜单');
INSERT INTO `sys_menu` VALUES ('102', '菜单管理', '1', '11', 'menu', 'system/menu/index', '1', 'C', '0', '0', 'system:menu:list', 'tree-table', 'admin', '2018-03-16 11:33:00', 'admin', '2020-05-06 23:28:04', '菜单管理菜单');
INSERT INTO `sys_menu` VALUES ('103', '部门管理', '1', '2', 'dept', 'system/dept/index', '1', 'C', '0', '0', 'system:dept:list', 'tree', 'admin', '2018-03-16 11:33:00', 'admin', '2020-05-06 23:27:30', '部门管理菜单');
INSERT INTO `sys_menu` VALUES ('104', '岗位管理', '1', '8', 'post', 'system/post/index', '1', 'C', '0', '0', 'system:post:list', 'post', 'admin', '2018-03-16 11:33:00', 'admin', '2020-05-06 23:26:43', '岗位管理菜单');
INSERT INTO `sys_menu` VALUES ('105', '字典管理', '1', '10', 'dict', 'system/dict/index', '1', 'C', '0', '0', 'system:dict:list', 'dict', 'admin', '2018-03-16 11:33:00', 'admin', '2020-05-06 23:28:21', '字典管理菜单');
...
INSERT INTO `sys_menu` VALUES ('2012', '组织属性', '1', '1', 'attribute', 'system/attribute/index', '1', 'C', '0', '0', 'system:attribute:list', 'table', 'admin', '2018-03-01 00:00:00', 'admin', '2020-05-06 22:17:35', '组织属性菜单');
INSERT INTO `sys_menu` VALUES ('2013', '组织属性查询', '2012', '1', '#', '', '1', 'F', '0', '0', 'system:attribute:query', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2014', '组织属性新增', '2012', '2', '#', '', '1', 'F', '0', '0', 'system:attribute:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2015', '组织属性修改', '2012', '3', '#', '', '1', 'F', '0', '0', 'system:attribute:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2016', '组织属性删除', '2012', '4', '#', '', '1', 'F', '0', '0', 'system:attribute:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2017', '组织属性导出', '2012', '5', '#', '', '1', 'F', '0', '0', 'system:attribute:export', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2024', '历史组织', '1', '3', 'olddept', 'system/olddept/index', '1', 'C', '0', '0', 'system:olddept:list', 'tab', 'admin', '2018-03-01 00:00:00', 'admin', '2020-05-06 23:26:25', '历史组织菜单');
INSERT INTO `sys_menu` VALUES ('2025', '历史组织查询', '2024', '1', '#', '', '1', 'F', '0', '0', 'system:olddept:query', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2029', '历史组织导出', '2024', '5', '#', '', '1', 'F', '0', '0', 'system:olddept:export', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
